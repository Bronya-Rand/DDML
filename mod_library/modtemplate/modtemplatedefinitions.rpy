...
# Backgrounds
# Below "image end" is where you should start adding your custom-made backgrounds like so
# (image bg classroom = "mod_assets/mod_library/modtemplate/mod_assets/bg/classroom.png")
image black = "#000000"
image dark = "#000000e4"
...
#In this category is where all the characters are defined by head and pose.
#The "1" here stands for the pose of each character while "a" defines the face expression so Sayori 1a would define her normal pose.
# Sayori
...
# Natsuki's Turn on the Xbox *cough* on the Definitions Roster
...
###### Character Variables ######
# These configure the shortcuts for writing dialog for each character. To make a new one, do this
# define sk = DynamicCharacter('sk_name', image='"', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
